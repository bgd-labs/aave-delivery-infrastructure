...
// src/contracts/emergency/interfaces/ICLEmergencyOracle.sol
...
// src/contracts/emergency/interfaces/IEmergencyConsumer.sol
...
// src/contracts/old-oz/Initializable.sol
...
abstract contract Initializable {
    ...
    modifier initializer() {
        ...
        require(
            (isTopLevelCall && _initialized < 1) || (!Address_0.isContract(address(this)) && _initialized == 1),
...
// src/contracts/emergency/EmergencyConsumer.sol
...
abstract contract EmergencyConsumer is IEmergencyConsumer {
    ...
    modifier onlyInEmergency() {
        ...
        require(answer > 0 && uint256(answer) > _emergencyCount, Errors_1.NOT_IN_EMERGENCY);
    ...
    function _updateCLEmergencyOracle(address chainlinkEmergencyOracle) internal {
        require(chainlinkEmergencyOracle != address(0), Errors_1.INVALID_EMERGENCY_ORACLE);
...
// src/contracts/interfaces/ICrossChainControllerWithEmergencyMode.sol
...
// src/contracts/CrossChainControllerWithEmergencyMode.sol
    ...
    EmergencyConsumer
{
    ...
    function solveEmergency(
        ...
        // receiver side
        _configureReceiverBasics(receiverBridgeAdaptersToAllow, receiverBridgeAdaptersToDisallow, newConfirmations);
        _updateMessagesValidityTimestamp(newValidityTimestamp);
