...
//  }
//
//  function getChainIdByName(
//    string memory networkName,
//    bool isTestnet
//  ) internal pure returns (uint256) {
//    if (networkName.eq('ethereum')) {
//      return isTestnet ? TestNetChainIds.ETHEREUM_SEPOLIA : ChainIds.ETHEREUM;
//    } else if (networkName.eq('polygon')) {
//      return isTestnet ? TestNetChainIds.POLYGON_MUMBAI : ChainIds.POLYGON;
//    } else if (networkName.eq('avalanche')) {
//      return isTestnet ? TestNetChainIds.AVALANCHE_FUJI : ChainIds.AVALANCHE;
//    } else if (networkName.eq('arbitrum')) {
//      return isTestnet ? TestNetChainIds.ARBITRUM_GOERLI : ChainIds.ARBITRUM;
//    } else if (networkName.eq('optimism')) {
//      return isTestnet ? TestNetChainIds.OPTIMISM_GOERLI : ChainIds.OPTIMISM;
//    } else if (networkName.eq('metis')) {
//      return isTestnet ? TestNetChainIds.METIS_TESTNET : ChainIds.METIS;
//    } else if (networkName.eq('bnb')) {
//      return isTestnet ? TestNetChainIds.BNB_TESTNET : ChainIds.BNB;
//    } else if (networkName.eq('base')) {
//      return isTestnet ? TestNetChainIds.BASE_GOERLI : ChainIds.BASE;
//    } else if (networkName.eq('gnosis')) {
//      return isTestnet ? TestNetChainIds.GNOSIS_CHIADO : ChainIds.GNOSIS;
//    } else if (networkName.eq('scroll')) {
//      return isTestnet ? TestNetChainIds.SCROLL_SEPOLIA : ChainIds.SCROLL;
//    } else {
...
//    return DeployerHelpers.getChainIdByName(vm.envString('NETWORK'), vm.envBool('IS_TESTNET'));
//  }
//
