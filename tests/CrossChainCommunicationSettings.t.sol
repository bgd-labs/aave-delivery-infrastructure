...
contract CrossChainCommunicationSettingsTest is BaseCCCommunicationTest {
  function x_test_Eth_Eth_Path() public {
  ...
  function x_test_Eth_Pol_Path() public {
    _checkPath(
      GovernanceV3Ethereum.CROSS_CHAIN_CONTROLLER,
  ...
  function x_test_Pol_Eth_Path() public {
    _checkPath(
      GovernanceV3Polygon.CROSS_CHAIN_CONTROLLER,
      GovernanceV3Ethereum.CROSS_CHAIN_CONTROLLER,
      ChainIds.POLYGON,
  ...
  function x_test_Eth_Avax_Path() public {
    _checkPath(
      GovernanceV3Ethereum.CROSS_CHAIN_CONTROLLER,
  ...
  function x_test_Avax_Eth_Path() public {
    _checkPath(
      GovernanceV3Avalanche.CROSS_CHAIN_CONTROLLER,
      GovernanceV3Ethereum.CROSS_CHAIN_CONTROLLER,
      ChainIds.AVALANCHE,
  ...
  function x_test_Eth_Op_Path() public {
    _checkPath(
      GovernanceV3Ethereum.CROSS_CHAIN_CONTROLLER,
  ...
  function x_test_Eth_Arb_Path() public {
    _checkPath(
      GovernanceV3Ethereum.CROSS_CHAIN_CONTROLLER,
  ...
  function x_test_Eth_Base_Path() public {
    _checkPath(
      GovernanceV3Ethereum.CROSS_CHAIN_CONTROLLER,
  ...
  function x_test_Eth_BNB_Path() public {
    _checkPath(
      GovernanceV3Ethereum.CROSS_CHAIN_CONTROLLER,
  ...
  function x_test_Eth_Metis_Path() public {
    _checkPath(
      GovernanceV3Ethereum.CROSS_CHAIN_CONTROLLER,
